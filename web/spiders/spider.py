...
class web(CrawlSpider):
    ...
    def parse_item (self,response):
        ...
        web_item['empresa'] = response.xpath('normalize-space(//*[@id="urlverofertas"])').extract()
        web_item['descripcion'] = response.xpath('normalize-space(//*[@id="MainContainer"]/article/section[1]/div[2]/ul/li[2])').extract()
        ...
        web_item['localizacion'] = response.xpath('normalize-space(//*[@id="MainContainer"]/article/section[4]/ul/li[3]/p)').extract()
        web_item['jornada'] = response.xpath('normalize-space(//*[@id="MainContainer"]/article/section[4]/ul/li[4]/p)').extract()
        web_item['tipo'] = response.xpath('normalize-space(//*[@id="MainContainer"]/article/section[4]/ul/li[5]/p)').extract()
        web_item['salario'] = response.xpath('normalize-space(//*[@id="MainContainer"]/article/section[4]/ul/li[6]/p)').extract()
        ...
        if self.item_count >100:  #limite de cuentas paginas hacemos scraping
